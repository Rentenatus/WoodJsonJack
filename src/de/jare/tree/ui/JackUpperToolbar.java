 ...
 */
public class JackUpperToolbar extends JPanel implements ContentListener, TreeFocusListener, UndoRedoListener {

    private final JackMasterControl master;
    private final de.jare.tree.control.JackUndoManager undoMan;
    ...
    public JackUpperToolbar(JackMasterControl master) {
